  ...
  return (
    <div className="w-full h-full relative z-0">
      ...
      >
        ...
        {/* ⚡ Bolt Optimization: Pass stable `setSelectedObj` reference directly instead of an inline arrow function */}
        {/* This allows React.memo inside UserMarker, ReportMarker, and EventMarker to prevent expensive map marker re-renders */}
